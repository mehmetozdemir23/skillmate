                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($receivedServiceRequests as $request)
                        ...
                        <tr class="hover:bg-gray-100 cursor-pointer"
                            onclick="location.href='{{ route('serviceRequests.show', ['serviceRequest' => $request, 'service' => $service]) }}'">
                            ...
                            <td class="p-4 lg:p-5">
                                <form
                                    action="{{ route('serviceRequests.destroy', ['serviceRequest' => $request, 'service' => $service]) }}"
