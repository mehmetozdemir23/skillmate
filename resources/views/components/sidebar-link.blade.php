...
<li>
    <a href="{{ route($routeName) }}"
        class="{{ $isCurrentRoute ? 'font-semibold bg-gray-200 ' : 'bg-white ' }}w-max lg:w-full flex items-center p-2 lg:pl-4 text-base text-gray-900 rounded-lg hover:bg-gray-200 group ">
