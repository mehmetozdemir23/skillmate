...
<div class="relative">
    ...
    <div id="user-dropdown"
        class="hidden absolute top-100 right-0 z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44  ">
        ...
        <ul class="py-2 text-sm text-gray-700 " aria-labelledby="avatarButton">
            ...
            <li>
                <form action="{{ route('logout') }}" method="post" class="w-full">
                    @csrf
                    <button type="submit"
                        class="w-full px-4 py-2 text-left text-sm text-red-600 font-semibold hover:bg-gray-100   ">Sign
                        out</button>
                </form>
            </li>
        </ul>
