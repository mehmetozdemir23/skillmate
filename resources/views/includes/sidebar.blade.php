<aside id="sidebar"
    class="static pt-4 lg:fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 lg:w-64 h-full lg:pt-24 font-normal duration-75 flex transition-width"
    aria-label="Sidebar">
    <div class="relative flex flex-col flex-1 min-h-0 pt-0 bg-white border-r border-gray-200">
        <div class="flex flex-col flex-1 pb-4 overflow-y-auto">
            <div class="flex-1 flex flex-col px-3 bg-white divide-y divide-gray-200">
                ...
                <div class="hidden lg:block px-3 text-xs mt-auto">
